import { decimal, integer, jsonb, pgSchema, primaryKey, timestamp, uuid, varchar } from 'drizzle-orm/pg-core';
...
export const entitlementAudit = librarySchema.table(
  'entitlement_audit',
  {
...
export const outboxEvents = librarySchema.table(
  'outbox_events',
  {
    id: uuid('id').defaultRandom().primaryKey(),
    eventType: varchar('event_type', { length: 100 }).notNull(),
