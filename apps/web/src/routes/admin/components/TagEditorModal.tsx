...
const PRESET_TAGS = [
  'Open World', 'Souls-like', 'Dark Fantasy', 'Single Player', 'RPG', 'Atmospheric',
  'Roguelike', 'Pixel Art', 'Co-op', 'Action', 'Strategy', 'Turn-Based',
  'Political', 'Story Rich', 'Survival', 'Crafting', 'Multiplayer', 'Cyberpunk',
  'Neon', 'Linear', 'Puzzle', 'Relaxing', 'Short', 'Shooter', 'Tactical',
  'Competitive', 'Space', 'Sci-Fi', 'Horror', 'Dark', 'City Builder', 'Steampunk',
  'Sandbox', 'Narrative', 'Visual Novel', 'Mystery', 'Western', 'Mature',
];
          ...
          <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '0.75rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.5rem' }}>
              <div style={{ position: 'relative', flex: 1, display: 'flex', alignItems: 'center' }}>
                <Hash size={12} style={{ position: 'absolute', left: '0.75rem', color: 'var(--text-muted)' }} />
                <input
                  type="text"
