...
import { HATHOR_ORANGE, GOLD_ACCENT, GREEN_ACCENT, BG, SURFACE, TEXT_PRIMARY } from "../../types/designerTypes";
import { sanitizeHexInput, hsvToHex, hexToHsv } from "../../utils/colorUtils";
import styles from "../../DesignerPage.module.css";

export function ColorField({ value, onChange, placeholder = "#000000 or transparent" }: { value: string; onChange: (v: string, skipHistory?: boolean) => void; placeholder?: string }) {
