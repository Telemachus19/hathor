        ...
        return (
          <div
            ...
            style={{
              ...
              paddingTop: col.pt || 0,
              paddingBottom: col.pb || 0,
              paddingLeft: col.pl ?? col.ph ?? 0,
              paddingRight: col.pr ?? col.ph ?? 0,
                ...
                return (
                  ...
                  >
                    ...
                    {(el.type === 'game-hero' ||
                      ...
                      el.type === 'carousel') && (
                      <GameCarousel s={el as any} device={device} pageSettings={pageSettings} />
                    )}
                    {el.type === 'game-header' && (
                      <GameDetailsHeader s={el} device={device} pageSettings={pageSettings} />
                    )}
                    {el.type === 'ownership-banner' && (
                      <GameOwnershipBanner s={el} device={device} />
                    )}
                    {el.type === 'about-game' && (
                      <GameAbout s={el} device={device} pageSettings={pageSettings} />
                    )}
                    {el.type === 'system-reqs' && (
                    ...
                    {el.type === 'features' && (
                      <GameFeatures s={el as any} device={device} pageSettings={pageSettings} />
                    )}
                    {el.type === 'two-col' && (
                    ...
                    {el.type === 'heading' && (
                      <HeadingRenderer s={el} device={device} pageSettings={pageSettings} />
                    )}
                    {el.type === 'text' && (
                      <TextRenderer s={el} device={device} pageSettings={pageSettings} />
                    )}
