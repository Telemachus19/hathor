...
export function SectionWrapper({ section: s, device, pageSettings, selected, selectedColIdx, selectedElementId, isFirst, isLast, onSelect, onSelectChild, onMoveUp, onMoveDown, onDuplicate, onDelete }: {
