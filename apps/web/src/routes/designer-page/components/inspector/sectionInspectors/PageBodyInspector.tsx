...
import { PageSettings, DEFAULT_PAGE_SETTINGS, HATHOR_ORANGE, FONTS } from "../../../types/designerTypes";
      ...
      <div style={{ flex: 1, overflowY: "auto" }}>
        ...
        <PropSection title="Global Typography & Theme Accents">
          <PropRow label="Header Title Font Family">
            <SelField value={ps.titleFont || "'Cinzel', serif"} onChange={v => uPage({ titleFont: v })} options={FONTS} />
          </PropRow>
          <PropRow label="Body Text Font Family">
            <SelField value={ps.textFont || "'Raleway', sans-serif"} onChange={v => uPage({ textFont: v })} options={FONTS} />
          </PropRow>
          <PropRow label="Primary Accent Color">
            <ColorField value={ps.accentColor || HATHOR_ORANGE} onChange={v => uPage({ accentColor: v })} />
          </PropRow>
        </PropSection>
        ...
        <PropSection title="Outer Viewport Padding">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
            <PropRow label="Pad Top"><NumField value={ps.padTop ?? 0} onChange={v => uPage({ padTop: v })} unit="px" max={200} /></PropRow>
            <PropRow label="Pad Bottom"><NumField value={ps.padBottom ?? 40} onChange={v => uPage({ padBottom: v })} unit="px" max={200} /></PropRow>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
            <PropRow label="Pad Left"><NumField value={ps.padLeft ?? 0} onChange={v => uPage({ padLeft: v })} unit="px" max={200} /></PropRow>
            <PropRow label="Pad Right"><NumField value={ps.padRight ?? 0} onChange={v => uPage({ padRight: v })} unit="px" max={200} /></PropRow>
          </div>
        </PropSection>
      </div>
    </div>
