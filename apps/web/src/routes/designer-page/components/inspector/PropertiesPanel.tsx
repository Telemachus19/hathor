...
import { PropSection, PropRow, ColorField, NumField, SelField, TxtInput, AlignmentGridPicker } from "../controls";
...
export function PropertiesPanel({ section, selectedColIdx, selectedElementId: propElementId, onChange, pageSettings, onPageSettingsChange, onDeselectAll }: {
  ...
  if (!section) {
    return <PageBodyInspector pageSettings={pageSettings} onPageSettingsChange={onPageSettingsChange} />;
  }
  ...
  return (
    <div className={styles.rightSidebar}>
      ...
      <div style={{ flex: 1, overflowY: "auto" }}>
        ...
        {targetObj.type === "game-header" && <GameHeaderInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "about-game" && <AboutGameInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "system-reqs" && <SystemReqsInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "user-reviews" && <UserReviewsInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "ownership-banner" && <OwnershipBannerInspector targetObj={targetObj} updateTarget={updateTarget} />}

        {targetObj.type === "sidebar-cta" && <SidebarCtaInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "sidebar-info" && <SidebarInfoInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "sidebar-ratings" && <SidebarRatingsInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "sidebar-community" && <SidebarCommunityInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "recommendations" && <RecommendationsInspector targetObj={targetObj} updateTarget={updateTarget} />}

        {targetObj.type === "text" && <TextBlockInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "heading" && <HeadingBlockInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "image" && <ImageBlockInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "button" && <ButtonBlockInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "features" && <FeaturesInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "two-col" && <TwoColInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "cta" && <CtaBlockInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "divider" && <DividerInspector targetObj={targetObj} updateTarget={updateTarget} />}
        {targetObj.type === "spacer" && <SpacerInspector targetObj={targetObj} updateTarget={updateTarget} />}
