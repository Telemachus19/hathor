...
import { SectionType, ElementType, HATHOR_ORANGE, BORDER, TEXT_MUTED, TEXT_PRIMARY } from "../../types/designerTypes";
import styles from "../../DesignerPage.module.css";

export function PaletteGridCard({ item, onAdd, onAddGridWithCols }: { item: any; onAdd: (type: SectionType | ElementType) => void; onAddGridWithCols: (template: string) => void }) {
