...
export interface Section {
  ...
  text?: string; font?: string; size?: number; weight?: string; color?: string; align?: "left" | "center" | "right";
  lineHeight?: number; letterSpacing?: string; textTransform?: "uppercase" | "capitalize" | "lowercase" | "none";
  fullWidth?: boolean;
  // Image properties
  imageSrc?: string; imageAlt?: string; imageMaxWidth?: number; imageRadius?: number; imageShadow?: boolean;
  // Button properties
  btnText?: string; btnBg?: string; btnGradient?: string; btnColor?: string; btnHoverBg?: string; btnHoverColor?: string; btnBorderColor?: string; btnIcon?: "download" | "library" | "cart" | "check" | "thumbs-up" | "star" | "none"; btnPaddingV?: number; btnPaddingH?: number; btnRadius?: number;
  // Game Hero
  heroImages?: string[]; heroHeight?: number; showThumbnails?: boolean; heroShadowEnabled?: boolean; heroShadowColor?: string;
  // Game Header
  ...
  ratingScoreFont?: string; ratingScoreColor?: string; headerRatingColor?: string;
  reviewCountFont?: string; reviewCountColor?: string; headerReviewCountColor?: string;
  devFont?: string; devColor?: string; headerDevColor?: string;
  dateFont?: string; dateColor?: string; headerDateColor?: string;
  titleFont?: string; titleColor?: string;
  subtitleFont?: string; subtitleColor?: string;
  tagBg?: string; tagColor?: string; tagBorder?: string;
  descColor?: string; descBorderColor?: string;
  headerBg?: string; headerBorder?: string; headerRadius?: number; headerPadTop?: number; headerPadBottom?: number; headerPadLeft?: number; headerPadRight?: number; badgeColor?: string; starColor?: string; accentColor?: string;
  // Ownership Banner
  ownershipStatus?: string; ownershipSub?: string;
  ownershipBtn1?: string; ownershipBtn2?: string;
  ownershipBtn1Bg?: string; ownershipBg?: string; ownershipBorder?: string;
  ownershipTitleFont?: string; ownershipTitleColor?: string;
  ownershipSubColor?: string; ownershipBtn1Color?: string;
  ownershipBtn2Bg?: string; ownershipBtn2Color?: string;
  // About Game
  aboutTitle?: string;
  aboutSections?: { title: string; text: string; img?: string }[];
  aboutTitleFont?: string; aboutTitleColor?: string; subTitleColor?: string;
  aboutSubheadingFont?: string; aboutSubheadingColor?: string;
  aboutBodyFont?: string; aboutBodyColor?: string;
  aboutBg?: string; aboutBorder?: string; aboutRadius?: number; borderColor?: string;
  // System Reqs
  ...
  reqsTitle?: string; reqsTitleFont?: string; reqsTitleColor?: string;
  reqsTabActiveBg?: string; reqsTabActiveColor?: string;
  reqsCardBg?: string; reqsCardBorder?: string;
  reqsLabelColor?: string; reqsValueColor?: string; reqsValueFont?: string;
  reqsAccentColor?: string; labelColor?: string; valueColor?: string;
  ...
  // Sidebar CTA
  sidebarPrice?: string; sidebarDiscount?: number; sidebarOwned?: boolean; sidebarOriginalPrice?: string;
  ownedTitle?: string; ownedTitleColor?: string; ownedHeaderColor?: string;
  ownedSubtext?: string; ownedSubtextColor?: string; sideBodyColor?: string;
  ownedPrimaryBtnText?: string; ownedPrimaryBtnBg?: string; ownedPrimaryBtnTextColor?: string; primaryBtnBg?: string; primaryBtnTextColor?: string;
  unownedPrimaryBtnText?: string; unownedPrimaryBtnBg?: string; unownedPrimaryBtnTextColor?: string;
  ctaSecondaryBtnText?: string; ctaSecondaryBtnTextColor?: string; ctaSecondaryBtnBorder?: string; ctaSecondaryBtnBg?: string;
  sidePriceColor?: string; priceColor?: string; originalPriceColor?: string; discountBg?: string; discountTextColor?: string;
  sideAccentColor?: string; sideCardBg?: string; sideCardBorder?: string; ctaBtnRadius?: number;
  sideHeaderFont?: string; sideHeaderColor?: string;
  ctaPrimaryBtnBg?: string; ctaPrimaryBtnTextColor?: string;
  // Sidebar Info
  sideDev?: string; sidePub?: string; sideDate?: string;
  sideGenre?: string; sidePlatforms?: string[];
  infoTitle?: string; infoTitleColor?: string; infoLabelColor?: string; infoValueColor?: string; infoTextColor?: string; infoCardBg?: string; infoCardBorder?: string;
  infoLabelFont?: string; infoValueFont?: string;
  // Sidebar Ratings
  sideRatings?: { stars: number; pct: number }[];
  ratingsTitle?: string; ratingsTitleColor?: string; ratingsLabelColor?: string; ratingsValueColor?: string; ratingsTextColor?: string; ratingsFillColor?: string; ratingsTrackColor?: string; ratingsPctColor?: string; ratingsCardBg?: string; ratingsCardBorder?: string;
  ratingsTitleFont?: string; ratingsLabelFont?: string;
  // Sidebar Community
  sideOwners?: string; sidePositive?: string;
  communityTitle?: string; communityTitleColor?: string; commTitleColor?: string; communityLabelColor?: string; commLabelColor?: string; communityValueColor?: string; commValueColor?: string; communityRatingColor?: string; commRatingColor?: string; communityPlayersColor?: string; communityPositiveColor?: string; communityCardBg?: string; communityCardBorder?: string;
  communityTitleFont?: string; communityLabelFont?: string;
  // Recommendations
  recsTitle?: string; recsTitleFont?: string; recsTitleColor?: string; recsItems?: RecItem[]; recsCount?: number;
  recsCardBg?: string; recsCardBorder?: string; recsCardRadius?: number; recsCardTitleFont?: string; recsCardTitleColor?: string;
  recsPriceFont?: string; recsPriceColor?: string; recsDiscountBg?: string; recsDiscountTextColor?: string; recsBg?: string;
  itemTitleFont?: string; itemTitleColor?: string; itemDescColor?: string; cardBg?: string; cardBorder?: string; cardRadius?: number;
  // Text
  ...
  featureItemTitleColor?: string; featureItemDescColor?: string; featuresCardBg?: string; featuresCardBorder?: string;
  // Two-col
  ...
  ctaTitleFont?: string; ctaTitleColor?: string; ctaSubtitleColor?: string; ctaAlign?: string; ctaBg?: string; ctaBorder?: string;
}
...
export interface FeatureItem { icon: string; title: string; desc: string; color: string; }
...
// ── ID generator ──────────────────────────────────────────────────────────────
let _seq = 1000;
export function uid() { return `sec_${Date.now()}_${++_seq}`; }
