    ...
    if (url.includes('youtube.com') || url.includes('youtu.be')) {
      ...
      return (
        <iframe
          ...
          style={{ width: '100%', height: '100%', border: 'none', background: contentBg, ...style }}
        ...
        {heroShadowEnabled && heroShadowColor !== 'transparent' && (
          <div
            style={{
              position: 'absolute',
              inset: 0,
              background: getShadowGradient(heroShadowColor),
              pointerEvents: 'none',
            }}
          />
        )}
...
export const GameDetailsHero = GameCarousel;
