...
export const GameCtaBlock: React.FC<GameCtaBlockProps> = ({ s = {}, device = 'desktop', pageSettings }) => {
  ...
  return (
    <div style={{
      background: s.ctaBg || 'linear-gradient(135deg, rgba(40, 24, 20, 0.6) 0%, rgba(18, 22, 30, 0.95) 100%)',
